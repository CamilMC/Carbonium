...
fpoc_moyen_mc <- colMeans(fpoc_annuel_mat)

flux_annuel_moyen <- mean(fpoc_moyen_mc)
flux_annuel_sd    <- sd(fpoc_moyen_mc)

quantile(fpoc_moyen_mc, c(0.05, 0.5, 0.95))
